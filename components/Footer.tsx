      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="border-t border-b border-white/5 py-8 mb-8 flex flex-col md:flex-row justify-between items-center gap-6">
           <div className="flex items-center gap-3 text-neutral-400">
             ...
             <span className="font-light tracking-wide text-sm">Janhviatel1010@gmail.com</span>
           </div>
           <div className="flex items-center gap-3 text-neutral-400">
             <svg className="w-5 h-5 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
             </svg>
             <span className="font-light tracking-wide text-sm">9236333827</span>
           </div>
           <div className="flex items-center gap-3 text-neutral-400 text-center md:text-left">
             ...
             <span className="font-light tracking-wide text-sm">Jhansi, Uttar Pradesh, India</span>
           </div>
        </div>
